...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Hangman", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Hangman", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Hangman";
		app.meta["name"] = "Hangman";
